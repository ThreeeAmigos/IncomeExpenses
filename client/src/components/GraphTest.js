...
import { ResponsiveContainer, LineChart, Line, CartesianGrid, XAxis, YAxis, Tooltip, Legend, Scatter, ScatterChart } from 'recharts'
    ...
    return (
        <>
            ...
            <LineChart margin={{
                ...
                <Line data={incomes - expenses} type="category" dataKey="amount" stroke="#82ca9d" />
            </LineChart>
            </ResponsiveContainer>
        </>
    )
